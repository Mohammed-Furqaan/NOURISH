    ...
    <div class="auth-container-card mx-3">
        ...
        <div class="auth-banner-side d-none d-md-flex">
            ...
            <div class="auth-banner-text">
                <h2>Discover the <br>best tastes now</h2>
                <p>Order fresh, delicious meals from your favorite local spots, delivered directly to your door.</p>
            </div>
        </div>
        ...
        <div class="auth-form-side">
            ...
            <h2 class="auth-form-title">Satisfy your <span>cravings</span></h2>
            <p class="auth-form-subtitle">Sign in to continue ordering</p>
            ...
            <div class="text-center">
                ...
                <a href="register.jsp" class="text-decoration-none fw-bold small ms-1" style="color: var(--primary-color);">Sign up</a>
            </div>
